 ...
 */
public class VASN1DefNumericString extends VASN1Definition {

	public VASN1DefNumericString() {
	}

	public VASN1DefNumericString(String name) {
		super(name);
	}
	...
	public ParseResult parseDER(byte[] data, boolean withTag)
		...
		for (int i = 0; i < str.length(); i++)
			if ("0123456789 ".indexOf(str.charAt(i)) < 0)
				throw new VASN1Exception("Decoded illegal NumericString character");
		return new ParseResult(new VASN1NumericString(str), tot_read);
	}
}
