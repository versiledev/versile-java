 ...
 * An ASN.1 SequenceOf.
 */
public class VASN1SequenceOf extends VASN1Sequence {
	 ...
	 */
	public VASN1SequenceOf() {
		if (this.name == null)
			this.name = "SEQUENCE OF";
	}
	 ...
	 */
	public VASN1SequenceOf(boolean defaultExplicit) {
	 ...
	 */
	public VASN1SequenceOf(boolean defaultExplicit, String name,
