...
/**
 * An ASN.1 UTF8String value.
 */
public class VASN1UTF8String extends VASN1Base implements VASN1String {
	 ...
	 * @param value value
	 */
	public VASN1UTF8String(String value) {
		this.value = value;
		if (this.name == null)
	 ...
	 */
	public VASN1UTF8String(String value, String name, VASN1Definition definition) {
	...
	public static VASN1Tag getUniversalTag() {
		try {
			return VASN1Tag.fromDER(new byte[] {(byte)0x0c}).getTag();
	...
	public byte[] encodeDER(boolean withTag) throws VASN1Exception {
		...
		try {
			buf.append(new VASN1OctetString(value.getBytes("utf8")).encodeDER(false));
