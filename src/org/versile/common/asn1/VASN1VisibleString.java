...
/**
 * An ASN.1 VisibleString value.
 */
public class VASN1VisibleString extends VASN1Base implements VASN1String {
	 ...
	 * @throws VASN1Exception invalid string
	 */
	public VASN1VisibleString(String value, String name, VASN1Definition definition)
			throws VASN1Exception {
	...
	public static VASN1Tag getUniversalTag() {
		try {
			return VASN1Tag.fromDER(new byte[] {(byte)0x1a}).getTag();
	...
	public VASN1Tag getTag() throws VASN1Exception {
		return VASN1VisibleString.getUniversalTag();
	}
