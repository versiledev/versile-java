...
/**
 * AlgorithmIdentifier ASN.1 type.
 */
public final class AlgorithmIdentifier extends VASN1DefSequence {

	public AlgorithmIdentifier() {
		super(true, "AlgorithmIdentifier");
		try {
			this.append(new VASN1DefObjectIdentifier(), "algorithm");
			this.append(new VASN1DefUniversal(true, null), "parameters");
