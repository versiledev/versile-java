...
/**
 * OtherPrimeInfo ASN.1 type.
 */
public final class OtherPrimeInfo extends VASN1DefSequence {
	public OtherPrimeInfo() {
		super("OtherPrimeInfo");
		try {
			this.append(new VASN1DefInteger(), "prime");
			this.append(new VASN1DefInteger(), "exponent");
