...
/**
 * Decoder for serialized {@link org.versile.orb.entity.VException} data
 */
public final class VExceptionDecoder extends VEntityDecoderBase {
	VEntity entity = null;
	...
	public VExceptionDecoder(VIOContext ctx, boolean explicit) {
		super(ctx, explicit);
		buf = new VByteBuffer();
	}
	...
	public boolean decodeHeader(VByteBuffer data) throws VEntityReaderException {
		...
		if (explicit && !have_code) {
			...
			if (code == 0xf7)
				...
				throw new VEntityReaderException("Invalid code for VException");
		}
	...
	public void putEmbeddedEntities(LinkedList<VEntity> entities)
		...
		entity = new VException(entities);
	}
