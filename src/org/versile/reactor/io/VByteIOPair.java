...
public class VByteIOPair {
	 ...
	 * @param producer
	 */
	public VByteIOPair(VByteConsumer consumer, VByteProducer producer) {
	 ...
	 */
	public void attach(VByteIOPair pair)
		throws IOException {
	 ...
	 * @throws IOException attach operation error
	 */
	public void attach(VByteIOPair pair, boolean safe)
		throws IOException {
