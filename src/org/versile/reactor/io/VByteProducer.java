...
/**
 * Producer of byte data.
 *
 * <p>Can be connected to a {@link VByteConsumer}. Implementing objects must
 * be connected to a {@link org.versile.reactor.VReactor} and be operated by
 * the reactor's main thread.</p>
 */
public interface VByteProducer extends VProducer {
	 ...
	 */
	public void attach(VByteConsumer consumer)
			throws IOException;
