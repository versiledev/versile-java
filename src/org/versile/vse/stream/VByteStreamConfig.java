...
/**
 * Configuration parameters for a byte stream connection.
 *
 * <p>Overrides some of the parent defaults with values are more appropriate for
 * a byte connection.</p>
 *
 * <ul>
 ...
 * </ul>
 */
public class VByteStreamConfig extends VStreamConfig {

	public VByteStreamConfig() {
