 ...
 *
 * <p>This stream class tracks stream elements as Object, performing
 * lazy-conversion of data received from or sent to stream. See
 * {@link VEntityStreamPeer} for a variation which does not perform
 * lazy-conversion.</p>
 */
public class VObjectStreamPeer extends VStreamPeer<Object> {

	/**
	 * Set up stream peer with default configuration parameters.
	 */
	public VObjectStreamPeer() {
		super(new VObjectStreamBuffer(), new VStreamConfig());
	}
	 ...
	 */
	public VObjectStreamPeer(VStreamConfig config) {
		super(new VObjectStreamBuffer(), config);
	}
	...
	public void peer_read_push(long msg_id, long read_ctx, Object[] data, boolean eos)
			throws VCallError {
		...
		synchronized(this) {
			...
			class Call extends VSequenceCallQueue.LocalCall {
				...
				Object[] data;
				boolean eos;
				public Call(long read_ctx, Object[] data, boolean eos) {
	 ...
	 * @throws VStreamError
	 */
	public synchronized VObjectStream<Object> connect(VProxy peer)
		throws VStreamError {
		this.initConnect(peer);
		return new VObjectStream<Object>(this);
	}
}
