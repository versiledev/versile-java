 ...
 *
 * <p>Operates on lazy-convertible VEntity objects.</p>
 */
public class VObjectStreamer extends VStreamer<Object> {
	 ...
	 */
	public VObjectStreamer(VStreamerData<Object> data)
			throws VStreamError {
		super(data, new VObjectStreamBuffer(),
	 ...
	 */
	public VObjectStreamer(VStreamerData<Object> data, VStreamMode mode)
			throws VStreamError {
		super(data, new VObjectStreamBuffer(), mode, new VStreamerConfig());
	}

	/**
	 * Set up streamer.
	 *
	 * Parameters are similar to {@link VStreamer}.
	 */
	public VObjectStreamer(VStreamerData<Object> data, VStreamMode mode, VStreamerConfig config)
			throws VStreamError {
		super(data, new VObjectStreamBuffer(), mode, config);
	}
	...
	public synchronized void peer_write_push(long callID, long writeCtx, Object[] data)
			throws VCallError {
		...
		class Call extends VSequenceCallQueue.LocalCall {
			long write_ctx;
			Object[] data;
			public Call(long write_ctx, Object[] data) {
	 ...
	 */
	public static VStreamer<Object> createFixedDataStreamer(Object[] data, boolean allowRew,
															boolean allowFwd,
														    VStreamerConfig config)
			throws VStreamError {
		VStreamerData<Object> s_data = new VObjectFixedStreamerData(data);
		VStreamMode mode = s_data.getRequiredMode()[0].clone();
		if (allowRew)
			mode.setSeekRew(true);
		if (allowFwd)
			mode.setSeekFwd(true);
		return new VObjectStreamer(s_data, mode, config);
	}
	 ...
	 * @throws VStreamError error creating streamer
	 */
	public static VStreamer<Object> createIteratorStreamer(Iterator<Object> iter, VStreamerConfig config)
			throws VStreamError {
		VStreamerData<Object> s_data = new VObjectIteratorStreamerData(iter);
