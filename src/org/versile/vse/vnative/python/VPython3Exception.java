...
/**
 * Represents a native python 3.x exception.
 */
public class VPython3Exception extends VPythonException {
	 ...
	 */
	public VPython3Exception(VEntity[] args) {
		super(new VString("vse-python-3.x"), args);
	}
	...
	public static VNativeModule.ExceptionDecoder _v_vse_exception_decoder() {
		class Decoder extends VNativeModule.ExceptionDecoder {
			...
			public VCombiner.Pair decode(VTuple tuple) throws CombineException {
				...
				result = new VPython3Exception(tuple._v_native());
				Vector<Object> objs = new Vector<Object>();
				objs.add(result);
